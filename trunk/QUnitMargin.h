 ...
 *\date May 2011
 *\version 0.1
 *\note A file containing the methods declarations to creates a horizontal rule in pixels.
...
/*!
 * \class QUnitMargin
 * \brief A class containing the methods declarations to creates a horizontal rule in pixels.
 */
