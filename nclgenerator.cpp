 ...
 *\return void
 */
void NclGenerator::createNCL(GraphicsScene *graphicsScene, DiagramSceneHead *graphicsSceneHead,DiagramScene *graphicsSceneTemporal,QString path,
 ...
 *\return void
 */
void NclGenerator::MakeRegionBase(GraphicsScene *graphicsScene)
{
 ...
 *\return void
 */
void NclGenerator::addExplicitDur(QList<Descriptor*> descriptorList,QString nameTempLineCorriente,QString longTempLine)
{
    QString mediaName;    
 ...
 *\param QList<Media*> mediaVideoList
 */
Media * NclGenerator::getMedia(QString nameTempLine,QList<Media*> mediaAudioList,QList<Media*> mediaImageList,QList<Media*> mediaTextList,QList<Media*> mediaVideoList)
{
    Media* returnMedia;
    for (int i=0; i < mediaVideoList.size(); i++){
 ...
 *\return void
 */
void NclGenerator::addProperty(DiagramScene *graphicsSceneTemporal,QList<Media*> mediaAudioList,QList<Media*> mediaImageList,
 ...
 *\return void
 */
void NclGenerator::addRoles(Image *boton,QString nameTempLineCorriente,int interfaceNumber)
{
    QString nameAux ="";
    BindParam *bindParam;
    Bind *bind;
 ...
 *\return void
 */
void NclGenerator::addInterface(QString nameArea,QString beginArea,QString endArea,QString nameTempLineCorriente,QList<Media*> mediaAudioList,QList<Media*> mediaImageList,
 ...
 *\return void
 */
void NclGenerator::makeLinks(DiagramScene *graphicsSceneTemporal,DiagramSceneHead *graphicsSceneHead,QList<Descriptor*> descriptorList,
                            QList<Media*> mediaVideoList,QList<Media*> mediaAudioList,QList<Media*> mediaImageList,QList<Media*> mediaTextList,
 ...
 *\return void
 */
void NclGenerator::clearAllProperties(QList<Media*> mediaVideoList,QList<Media*> mediaAudioList,QList<Media*> mediaImageList,QList<Media*> mediaTextList,
                                 QList<Media*> mediaLuaList,QList<Media*> mediaUriList,QList<Descriptor*> descriptorList)
{
    for(int i = 0; i < descriptorList.size();i++){
 ...
 *\return void
 */
void NclGenerator::clearAreaLists(QList<Media*> mediaVideoList,QList<Media*> mediaAudioList,QList<Media*> mediaImageList,QList<Media*> mediaTextList,
                                 QList<Media*> mediaLuaList,QList<Media*> mediaUriList)
{
